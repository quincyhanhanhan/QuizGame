...
const RECORDS: DatabaseRecord[] = [
  ...
  },
  {
    ...
    content: `
      ...
      【简介】
      分管后勤与财务。风评不佳，据传在旧楼拆迁项目中存在违规行为。近期正在发起针对内勤部门的“合规审计”。
    `,
  },
  {
    id: 'ITEM_DAGGER',
  ...
  // 第一梯队：第一发现人 & 法医
  {
    ...
    content: `
      ...
      【简介】
      刚分配到旧北区分局的实习生。为人热心但经验不足。案发时的第一发现人。
    `,
    crossExamination: [
      {
        triggerRecordId: 'DEFAULT',
        topic: '基本口供',
        content: '"我来找赵局签字。敲门没人应，但是手机一直在响。我就叫来了在走廊抽烟的 [老李] 和在楼下修电路的 [老王] 一起撞开了门。"'
      }
    ]
  },
  {
    ...
    content: `
      ...
      【简介】
      随身携带勘查箱。做事干练。死亡时间推定：20:00-20:30之间。
    `,
    crossExamination: [
      {
        triggerRecordId: 'DEFAULT',
        topic: '协助提示',
        content: '"我在二楼技术科有个临时的 [化验台]，如果你们在现场发现了什么不明物质，可以拿来给我化验。"'
      }
    ]
  },
  {
  ...
  // 第二梯队：由陈宇引出
  {
    ...
    content: `
      ...
      【简介】
      资深刑警，也是多年的老烟枪。案发时正倚靠在走廊尽头的窗边抽烟。
    `,
    crossExamination: [
      {
        triggerRecordId: 'DEFAULT',
        topic: '基本口供',
        content: '“我没看到任何人进出局长办公室。这走廊一眼就能望到头。哦对了，只有内勤 [小刘] 抱着一大堆东西路过 [走廊]，说是去送档案。”'
      }
    ]
  },
  {
    ...
    content: `
      ...
      【简介】
      负责局里的物资采购和设施维修。随身带着一个沉重的工具包。
    `,
    crossExamination: [
      {
        triggerRecordId: 'DEFAULT',
        topic: '基本口供',
        content: '"案发时我在楼下 [仓库] 整理库存，听到小陈喊叫才跑上来的。那仓库乱得很，只有我有钥匙。"'
      }
    ]
  },
  {
  ...
  // 第三梯队：由李建国引出
  {
    ...
    content: `
      ...
      【简介】
      性格内向，平时负责档案整理工作。案发前曾抱着一摞高过头顶的 [档案盒] 经过走廊。
      
      【特征】
      她的 [袖口] 处似乎有一块奇怪的半透明污渍。
    `,
    crossExamination: [
      {
        triggerRecordId: 'DEFAULT',
        topic: '基本口供',
        content: '"档案室在搬迁，我当时只是把整理好的旧卷宗搬去仓库。因为盒子太高挡住视线，我走得很慢... 我什么都没看见。"'
      },
      {
        triggerRecordId: 'DOC_AUDIT',
        topic: '关于：审计',
        content: '"(低头不语)... 我知道他在查账。但我没做亏心事，我不怕查。"'
      }
    ]
  },
