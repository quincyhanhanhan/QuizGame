import { DatabaseRecord, RecordType } from './types';

export const SYSTEM_NAME = "天网档案系统 (SkyNet Archives) v5.0";
export const CASE_ID = "CASE-2024-X92";
export const CASE_TITLE = "深蓝大厦CEO毒杀案";

// --- Logic Flow ---
// 1. Brief -> Mentions [42F Office], [Guo Feng]
// 2. Search "42F Office" -> Shows [Whiskey], [Pen], [Ventilation Duct], Mentions [Lin Ya] was there.
// 3. Search "Whiskey" -> Item detail. Mentions it was half drunk.
// 4. Search "Guo Feng" -> Victim profile. Mentions [Project DeepBlue].
// 5. Search "Lin Ya" -> Suspect. 
//    -> IF "Whiskey" is unlocked, Lin Ya explains she poured it.
// 6. Search "Project DeepBlue" -> Doc. Mentions [Chen Mo] opposed it.
// 7. Search "Chen Mo" -> Suspect.
//    -> IF "Project DeepBlue" unlocked, he rants about it.
//    -> IF "Ventilation Duct" unlocked, he denies knowing about it.
// 8. Search "Ventilation Duct" -> Requires [42F Office]. Finds [Handkerchief].
// 9. Search "Handkerchief" -> Evidence. Has "C.M." initials.

export const INITIAL_RECORD: DatabaseRecord = {
  id: 'SYS-001',
...
export const INITIAL_BRIEF_TEXT = INITIAL_RECORD.content;